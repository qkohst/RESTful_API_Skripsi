<article class="docs-article" id="section-11">
  <header class="docs-header">
    <h1 class="docs-heading pb-0">Admin/Seminar Proposal</h1>
    <p>
      Melihat data Seminar Proposal yang dilakukan oleh user dengan role Admin
    </p>
  </header>

  <!-- Lihat Seminar Proposal  -->
  <section class="docs-section pt-0" id="item-11-1">
    <h3 class="section-heading">Lihat Data Seminar Proposal </h3>
    <h4>
      <span class="badge badge-info">GET</span>
      <small>admin/seminarproposal</small>
    </h4>
    <p>
    ...
    <span class="hljs-attr">"data"</span>: [
      {
        ...
        <span class="hljs-attr">"status_seminar_proposal"</span>: <span class="hljs-string">"Selesai"</span>, 
      },
      {
        <span class="hljs-attr">"id"</span>: <span class="hljs-number">1</span>, 
        <span class="hljs-attr">"program_studi"</span>: {
        ...
        <span class="hljs-attr">"status_seminar_proposal"</span>: <span class="hljs-string">"Proses"</span>, 
      }
    ]
  }
                  </code>
  ...
  <!-- Fakultas By ID -->
  <section class="docs-section pt-3" id="item-11-2">
                  ...
                  <code class="json hljs">
  {
    ...
    <span class="hljs-attr">"data"</span>: {
      ...
      <span class="hljs-attr">"tanggal_seminar_proposal"</span>: <span class="hljs-string">"2021-05-27 08:00:00"</span>, 
      <span class="hljs-attr">"status_seminar_proposal"</span>: <span class="hljs-string">"Lulus Seminar"</span>, 
      <span class="hljs-attr">"nilai_akhir_seminar_proposal"</span>: <span class="hljs-number">84</span>, 
